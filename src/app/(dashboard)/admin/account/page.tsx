...
import { CreditCard, Database, Fingerprint, Mail, School, Settings, User } from 'lucide-react';
            ...
            <div className="mt-5 p-10 border bg-white dark:bg-slate-900 rounded-2xl ">
              <Tabs defaultValue="profile" className="flex justify-start gap-x-10">
                <div className="w-auto h-[220px] flex-row bg-slate-50 rounded-xl gap-y-10 px-3 pt-10 dark:bg-slate-500">
                  <TabsList className="flex-col  w-[200px] bg-transparent gap-y-5 mt-5 my-3">
                    <TabsTrigger
                    ...
                    "
                      value="school"
                    >
                      <School className="w-4 h-4 me-2" /> School
                    </TabsTrigger>
                  </TabsList>
                </div>
